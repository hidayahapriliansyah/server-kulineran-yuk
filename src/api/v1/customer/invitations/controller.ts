...
import * as invitationService from '.././../../../services/mongoose/customer/invitations';
import * as DTO from '.././../../../services/mongoose/customer/invitations/types';
...
const acceptInvitationBotramGroup = async (
  ...
  try {
    const result = 
      await invitationService.acceptInvitationBotramGroup(req) as DTO.InvitationBotramGroupResponse['_id'];
...
const rejectInvitationsBotramGroup = async (
  ...
  try {
    const result =
      await invitationService.rejectInvitationsBotramGroup(req) as DTO.InvitationBotramGroupResponse['_id'];
