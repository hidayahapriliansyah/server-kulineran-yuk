...
import * as customMenuService from '../../../../services/prisma/customer/custom-menu';
import * as DTO from '../../../../services/prisma/customer/custom-menu/types';
...
const createCustomMenu = async (
  ...
  try {
    const result = await customMenuService.createCustomMenu(req) as DTO.CustomMenuResponse['id'];
...
const updateCustomMenu = async (
  ...
  try {
    const result = await customMenuService.updateCustomMenu(req) as DTO.CustomMenuResponse['id'];
...
const deleteCustomMenu = async (
  ...
  try {
    const result = await customMenuService.deleteCustomMenu(req) as DTO.CustomMenuResponse['id'];
